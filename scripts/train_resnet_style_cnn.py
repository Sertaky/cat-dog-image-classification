"""Train the ResNetStyleCNN architecture experiment."""
...
def save_checkpoint(
    *,
    ...
    """Save the best ResNet-style model and its complete training state."""
...
def run_training(
    *,
    ...
    """Run the complete ResNet-style training and validation experiment."""
    set_random_seed(random_seed)
    pin_memory = device.type == "cuda"
    train_loader, val_loader, _ = build_classification_dataloaders(
        batch_size=batch_size,
...
def main() -> None:
    """Configure and run smoke verification or the full experiment."""
    random_seed = 42
    batch_size = 32
    num_workers = 4
    learning_rate = 0.001
