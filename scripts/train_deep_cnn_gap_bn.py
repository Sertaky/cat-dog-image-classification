"""Train the DeepCNNGAPBatchNorm architecture experiment."""
...
from src.models import DeepCNNGAPBatchNorm
...
def save_checkpoint(
    *,
    ...
    """Save the best deep model and its complete training state."""
    ...
    torch.save(
        {
            ...
            "model_name": "DeepCNNGAPBatchNorm",
...
def run_smoke_verification(
    *,
    ...
    model = DeepCNNGAPBatchNorm().to(device)
...
def run_training(
    *,
    ...
    """Run the complete deep-model training and validation experiment."""
    set_random_seed(random_seed)
    pin_memory = device.type == "cuda"
    train_loader, val_loader, _ = build_classification_dataloaders(
        batch_size=batch_size,
...
def main() -> None:
    """Configure and run smoke verification or the full deep experiment."""
    random_seed = 42
    batch_size = 32
    num_workers = 4
    learning_rate = 0.001
